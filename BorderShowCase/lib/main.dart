  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = 0; x < size.width; x += waveLength) {
      path.quadraticBezierTo(
        x + waveLength / 4, 0,
        x + waveLength / 2, waveHeight,
      );
      path.quadraticBezierTo(
        x + waveLength * 3 / 4, waveHeight * 2,
        x + waveLength, waveHeight,
      );
    }
    ...
    for (double x = size.width; x > 0; x -= waveLength) {
      path.quadraticBezierTo(
        x - waveLength / 4, size.height,
        x - waveLength / 2, size.height - waveHeight,
      );
      path.quadraticBezierTo(
        x - waveLength * 3 / 4, size.height - waveHeight * 2,
        x - waveLength, size.height - waveHeight,
      );
    }
